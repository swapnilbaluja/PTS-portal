...
<div class="container">
    ...
    <table id="sem5" class="table table-bordered">
        <thead>
            <tr><th colspan="3"><center>ASSIGNMENTS</center></th></tr>
            <tr>
...
for($i=1;$i<=$rowcount;$i++)
{
	...
	<tr>
                            <td width='20%'><?php echo $row["subject"]?> </td>
                            <td width='60%'> <?php echo $row["file"]?></td>
                            <td width='20%'> <a href="upload/<?php echo $row["file"]?>"><span class="glyphicon glyphicon-download-alt"></span>
	Download</a>  </td>
